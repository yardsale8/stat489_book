...
Note the order of the tuples in ``new_list``.  When using a two sequence
...
.. mchoice:: two_loops_1
    :answer_a: [(1, "a"), (1,"b"), (2, "a"), (2, "b")]
    :answer_b: [(1, "a"), (2,"a"), (1, "b"), (2, "b")]
    :answer_c: [(1, 2), ("a","b")]
    :correct: a
    :feedback_a: The comprehension cycles through each element in the second sequence before moving the the next item in the first.
    :feedback_b: The comprehension cycles through each element in the second sequence before moving the the next item in the first.
    :feedback_c: A comprehension with two sequences with cycle through all combination of items, not each sequence separately.

    Which list is generated by the following list comprehension?
...
.. mchoice:: two_loops_2
    :answer_a: [(0, 0), (0, 1), (1, 0), (1, 1)]
    :answer_b: [(0, 0), (0, 1), (1, 1)]
    :answer_c: [(0, 1), (1,)]
    :correct: b
    :feedback_a: The second range will start at the current value of the first range.
    :feedback_b: The second range will start at the current value of the first range.
    :feedback_c: A comprehension with two sequences with cycle through all combination of items, not each sequence separately.
